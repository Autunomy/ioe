...
<div class="col-md-4 col-md-offset-4">
    <form class="form" role="search" style="text-align: center" action="${pageContext.request.contextPath}/ioe/queryHistoryOrders">
        <div class="form-group">
            <input type="text" class="form-control" placeholder="可以根据姓名和学号搜索" name="search">
        </div>
