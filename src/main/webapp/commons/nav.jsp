            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="${pageContext.request.contextPath}/ioe/ioe_main.jsp">自己下单</a></li>
<%--                        <li><a href="${pageContext.request.contextPath}/ioe/friend_order.jsp">帮朋友下单</a></li>--%>
                        <li><a href="${pageContext.request.contextPath}/ioe/query_orders.jsp">订单信息查询</a></li>
