...
<div class="row">
    ...
    <div class="col-md-4">
        <form role="form" action="${pageContext.request.contextPath}/user/updateUser" method="get">
            ...
            <div class="form-group">
                <label for="user_email">邮箱<sup style="color: red">*</sup></label>
                <input type="text" class="form-control" id="user_email" name="user_email" value="${user.user_email==null?"":user.user_email}">
            </div>
